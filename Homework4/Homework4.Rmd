...
Another assumption that is needed for the model to be causal is the ability to manipulate one of the x's without that manipulation impacting the exogeneity with the error term.  This assumption is not very plausible.  It's hard to think of a situation where we can make a school appear in the final four / win a title / be champions in the previous year without affecting other variables (the error term).
...
MJ:  I think we should remove this paragraph\newline
