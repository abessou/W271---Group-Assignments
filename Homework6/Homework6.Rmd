...
The assumption of __weak stationarity__ (or second order stationarity) is a weaker assumption of stationarity. A time series $x_{t}$ is weak stationary if its mean and variance stationary and is auto-covariance  $Cov(x_{t}, x_{t+k})$ depends only on the lag k, and is not a function of time t.\newline
