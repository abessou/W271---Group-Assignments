...
hist(gas,main="Weekly Gas Prices", col="blue",
     xlab="Weekly Gas Price", ylab="Frequency")
```
...
**flu** - Seems to be a downward trend from the 60's leading into the 70's. After this, the trend remains flat with a steady seasonal variation (during flu season, winter months) with some years worse than others.  The spikes of the seasonal variation seem to be trending downward. 
We can speculate that the downward trend is due to improvements in health programs over the years.
...
Question 4
==========
- The AR(1) model with 0.9 has values from -7.1 to 8.2 with a mean of -0.1.
- The AR(1) model with 0.2 has values from -3.2 to 3.6 with a mean of -0.01.
...
- __Random walk without drift:__ This series has a mean of 7.42.  It trends flat from 0 to 800 and then has a slight upward trend.  There is some variation that is random.
- __Random walk with 0.5 drift:__ This series has a mean of 257.67.  It trends upward with a slope about 0.5.  There is some variation that is random.
