...
data.fit.ahead.fcast$lower[,2] <- -(((data.fit.ahead.fcast$mean-data.fit.ahead.fcast$lower[,2])/(1.96*sqrt(data.fit.ahead.fcast$model$sigma2)))*gw.garch.pred$standardDeviation)+data.fit.ahead.fcast$mean
data.fit.ahead.fcast$lower[,2]

data.fit.ahead.fcast$upper[,2] <- (((data.fit.ahead.fcast$upper[,2]-data.fit.ahead.fcast$mean)/(1.96*sqrt(data.fit.ahead.fcast$model$sigma2)))*gw.garch.pred$standardDeviation)+data.fit.ahead.fcast$mean
