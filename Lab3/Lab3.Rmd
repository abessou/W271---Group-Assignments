...
3.  ACF.  Mostly drops off after 1 lag with several lags out of the 95% confidence interval.  ?? Does this suggest a MA(1) component in the 1st differenced series.
...
- ACF.  Mostly drops off after 1 lag with several lags out of the 95% confidence interval.  ?? Does this suggest a MA(1) component in the 1st differenced series.
...
# Print the forecasted values and 95% CI.
df=data.frame(cbind(glob.warm.part.sarima.fcast$mean, glob.warm.part.sarima.fcast$lower[,2], glob.warm.part.sarima.fcast$upper[,2]))
names(df) = c("Mean", "Lower 95% conf", "Upper 95% conf")
stargazer(df, type="text", summary=FALSE)
```
