...
##### MEGAN'S CALCULATION ###
fcast=data.fit.ahead.fcast
sdGARCH = data.garch.pred$standardDeviation
v1 = ((fcast$upper[,2] - fcast$mean) / sqrt(fcast$model$sigma2)) * sdGARCH
lower = fcast$mean - v1
upper = fcast$mean + v1
print(data.fit.ahead.fcast$lower[,2]) # Charles' calc
print(lower) # Megan's calc
print(data.fit.ahead.fcast$upper[,2]) # Charles' calc
print(upper) # Megan's calc
