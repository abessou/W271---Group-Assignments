...
The p-value of the f-statistic of the model is significant at 8.109e-10, indicating that we should reject the null hypothesis.
The model accounts for 2.99% of the variability in the variable bwght
That value is givent by a R^2 value of 0.299 and a R value of 0.173 indicating a relatively small effect size
...
In the simple regression, we saw that this coefficient was also negative and had a value of -0.5147.
