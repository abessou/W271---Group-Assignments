...
```{r, tidy=TRUE, tidy.opts=list(width.cutoff=60)}
hist(hw07.series1, 100, , xlab='Time unit', ylab='Time series values', main='Histogram of time series data')
...
AR(2) model that we know is teh true model, has the closest AIC value to the AR(3) model.
...
leg 0 and non-significant for all other legs.
The partial autp-correlation confirms the pattern of the acf with non-significant pacf for all
legs greater than 0. The pattern is consistent with a white noise time series.
