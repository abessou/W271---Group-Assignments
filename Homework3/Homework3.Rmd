...
holding all other variables in the model fix and assuming zero-employment experience. It provides an indication of how much percentage point change to expect in the wage of an individual when they move from the baseline (white) to being black. Hence the coefficient captures the difference at the intercept of the log(wage) vs experience plot between black and white respondants.
